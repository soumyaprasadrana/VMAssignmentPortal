...
@Component({
  selector: 'app-snapshots-view',
  templateUrl: './snapshots-view.component.html',
  styleUrls: ['./snapshots-view.component.scss'],
  animations: [ToolsModule],
})
export class SnapshotsViewComponent implements OnInit {
