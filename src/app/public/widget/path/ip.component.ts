...
@Component({
  ...
  <tr>
  <td class="left-align">
  <span [ngbPopover]="warnPopOver" [autoClose]="'outside'"  container="body" placement="right" *ngIf="type=='warn'" class="btn  card badge badge-warning"><i class="fa fa-warning" aria-label="hidden"></i></span>
