...
export class SideNavComponent implements OnInit {
  ...
  versionInfo() {
    this.openAlertDialog({
      ...
      <p class="mb-0">Version: 2.11.0</p>
      <p class="mb-0">Build Number: 211-11092023</p>
      <p>Build Date: November 11, 2023</p>
      <p>
    VM Assignment Portal 2.11.0 © 2023 All rights reserved.</p>
