  ...
  ngOnInit(): void {
    ...
    const statuscellFormatter: Formatter<any> = (
      ...
      if (vm.activity_status == 'SUCCESS') {
        return {
          text: `<div style='text-align:center;width:auto;'> <span style='text-align:center;padding:5px;' class='badge bg-success'>${value}</span></div>`,
          toolTip: value,
        };
        ...
        return {
          text: `<div style='text-align:center;width:auto;'><span style='text-align:center;padding:5px;' class='badge bg-warning'>${value}</span></div>`,
          toolTip: value,
        };
      } else {
        return {
