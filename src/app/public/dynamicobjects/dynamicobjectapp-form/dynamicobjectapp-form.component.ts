...
import { DynamicObjectAppFormService } from "../../services/dynamicobjectappform.service";
import { CommonService } from "../../services/common.service";
@Component({
  selector: "app-dynamicobjectapp-form",
  templateUrl: "./dynamicobjectapp-form.component.html",
  styleUrls: [ "./dynamicobjectapp-form.component.scss" ],
})
export class DynamicObjectAppFormComponent implements OnInit {
  ...
  constructor(
    ...
    private dynamicobjectappServie: DynamicObjectAppFormService,
    private dialog: MatDialog,
    private _spinner: SpinnerService,
    private router: Router,
    private toastService: ToastService
  ) {
    dynamicobjectappServie
      .getTeams()
      .then((res) => {
        this.teamList = res;
      })
  ...
  onSubmit() {
    ...
    var _promise = this._client.post(
      "api/dynamicobjectform/" + this.app + "/submit",
      reqBodyToBeSent,
      httpOptions
    );
    _promise
  ...
  close() {
    ...
    var tempW = window.open(location.href, "_self", "");
    console.log(tempW);
    if (tempW != null) tempW.close();
  }
}
