...
module.exports = function(app) {
  ...
  app.get(
    "/api/dynamicobjects/userDefinedFunctions/:id",
    dynamicObjectCtrl.getUserFunction
  );
  app.get(
    "/api/dynamicobjects/userDefinedFunctions/:id/template",
    dynamicObjectCtrl.getUserFunctionTemplate
  );

  app.get("/api/dynamicobjects/getAll", dynamicObjectCtrl.getAll);
  app.get(
    "/api/dynamicobjects/:app/getAll",
    dynamicObjectCtrl.getObjectRecords
  );
  app.get(
    "/api/dynamicobjects/:app/attributes",
    dynamicObjectCtrl.getObjectAttributes
  );
  app.get(
    "/api/dynamicobjects/:app/functions",
    dynamicObjectCtrl.getObjectFunctions
  );
  app.get(
    "/api/dynamicobjects/:app/formenabled",
    dynamicObjectCtrl.getObjectFormEnabled
  );
  ...
  app.get(
    "/api/dynamicobjectform/getAttributes/:id",
    dynamicObjectCtrl.getObjectAttributesForObjectForm
  );
  app.get(
    "/api/dynamicobjectform/getUsers",
    dynamicObjectCtrl.getUsersForObjectForm
  );
  app.get(
    "/api/dynamicobjectform/getTeamList",
    dynamicObjectCtrl.getTeamsForObjectForm
  );
  app.get("/api/dynamicobjectform/lists", commonCtrl.getListsNames);
  app.get("/api/dynamicobjectform/lists/:id", commonCtrl.getListItems);
  app.post(
    "/api/dynamicobjectform/:app/submit",
    dynamicObjectCtrl.dynamicobjectappFormSubmit
  );
  ...
  app.get(
    "/api/config/userDefinedFunctions",
    commonCtrl.getUserDefinedFunctions
  );
  app.get(
    "/api/config/redirectToUserdefinedFunctions",
    commonCtrl.redirectToUserdefinedFunctions
  );
  ...
  app.post(
    ...
    snapCtrl.restartsnapshotservice
  );
